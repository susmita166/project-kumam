...
const addVendor = async (req,res) => {
    ...
    if (userDetail && (userDetail.department_id === 4 || userDetail.user_type === 'superadmin')) {
     ...
     return res.status(401).json({ message: "Only ULB users and superadmins are allowed to add water bodies." });
    }
}
